...
function createTable(db:any){
    let sql_order = 'CREATE TABLE IMAGE(ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,IMG_ID TEXT NOT NULL,PID INTEGER NOT NULL,VID INTEGER NOT NULL,UID INTEGER NOT NULL,DATE TIMESTAMP NOT NULL)';
    db.exec(sql_order);
}
