...
declare module "child_process" {
    ...
    function exec(command: string): ChildProcess;
    function exec(command: string, opt:Object): ChildProcess;
    function execSync(command: string): ChildProcess;
    function execSync(command: string, opt:Object): ChildProcess;
}
...
declare module "websocket" {
    ...
    // no `options` definitely means stdout/stderr are `string`.
    function createServer(...args: any[]): websocket;
}
declare module "pack";
